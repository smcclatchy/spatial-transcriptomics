...
sc.counts <- read.table("data/scRNA-seq/sc_counts.tsv", sep = "\t", header = TRUE, row.names = 1, quote = "", check.names = FALSE)

# Load cell type annotations
cofactor_loaded <- read.table("data/scRNA-seq/sc_cell_types.tsv", sep = "\t", header = TRUE, quote = "", stringsAsFactors = FALSE)

...
stop("Here, we expect to have two objects and need to load them in.")
stop("Do we have a second one?")
stop("I am reading in the first, but it may not be the right one")
stop("i.e., the one generated from the previous lesson.")

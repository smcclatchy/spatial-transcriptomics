...
```{r}
run.rctd <- function(st.obj, sc.counts, sc.cell.types) {
...
result_1 <- run.rctd(brain1, sc.counts, sc.cell.types, "rctd_st_brains_new.rds")
print_RCTD_results(brain1, result_1, 'brains_new.png')

# Deconvolution for brain sample 2
result_2 <- run.rctd(brain2, sc.counts, sc.cell.types, "rctd_st_brains_new2.rds")

...
```{r comparison_table, echo = FALSE, results = 'asis', eval=FALSE}
library(knitr)
tech <- read.csv("data/tech-comparison.csv")
kable(tech, caption = "Strengths and weaknesses of each technology", align = "c")
```
